...
RSpec.describe DesignsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all designs as @designs" do
      ...
      expect(assigns(:designs)).to eq([design])
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved design as @design" do
        post :create, {:design => invalid_attributes}, valid_session
        expect(assigns(:design)).to be_a_new(Design)
      end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the design as @design" do
        design = Design.create! valid_attributes
        put :update, {:id => design.to_param, :design => invalid_attributes}, valid_session
        expect(assigns(:design)).to eq(design)
      end
